...
/**
 * <p>
 * Java class for RoleTypeType complex type.
 * 
 * <p>
...
@XmlType(name = "RoleTypeType", propOrder = { "description", "startDate", "endDate", "state", "dateLamu", "userLamu",
		"language", "category", "helpInfo", "code", "responsibilityScope", "responsibilityTask",
		"responsibilitySupportTask", "responsibilityFeedback" })
public class RoleTypeType extends ElementType {
