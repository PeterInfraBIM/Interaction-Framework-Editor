...
/**
 * <p>
 * Java class for GroupTypeType complex type.
 * 
 * <p>
...
@XmlType(name = "GroupTypeType", propOrder = { "description", "startDate", "endDate", "state", "dateLamu", "userLamu",
		"language", "category", "helpInfo" })
public class GroupTypeType extends ElementType {
