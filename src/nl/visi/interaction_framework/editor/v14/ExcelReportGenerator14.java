...
import nl.visi.interaction_framework.editor.v14.MainFrameControl14.Tabs;
...
class ExcelReportGenerator14 extends Control14 {

	private final MainFrameControl14 mainFrameControl;

	public ExcelReportGenerator14(MainFrameControl14 mainFrameControl) {
	...
	private void writeRoleTypesSheet(WritableWorkbook workbook, int tabIndex) throws WriteException {
		...
		List<RoleTypeType> roleTypes = Editor14.getStore14().getElements(RoleTypeType.class);
	...
	private void writeTransactionTypesSheet(WritableWorkbook workbook, int tabIndex) throws WriteException {
		...
		List<TransactionTypeType> transactionTypes = Editor14.getStore14().getElements(TransactionTypeType.class);
...
//			sheet.addCell(new Label(col + 1, row, transactionType.getBasePoint(), getDataFormat()));
			...
			TransactionsPanelControl14 transactionsPC = MainFrameControl14.getTransactionsPC();
	...
	private void writeMessageTypesSheet(WritableWorkbook workbook, int tabIndex) throws WriteException {
		...
		for (MessageTypeType messageType : messageTypes) {
			...
			MessagesPanelControl14 messagesPC = MainFrameControl14.getMessagesPC();
	...
	private void writeComplexElementTypesSheet(WritableWorkbook workbook, int tabIndex) throws WriteException {
		...
		for (ComplexElementTypeType complexElementType : complexElementTypes) {
			...
			ComplexElementsPanelControl14 complexElementsPC = MainFrameControl14.getComplexElementsPC();
	...
	private void writeSimpleElementTypesSheet(WritableWorkbook workbook, int tabIndex) throws WriteException {
		...
		List<SimpleElementTypeType> simpleElementTypes = Editor14.getStore14().getElements(SimpleElementTypeType.class);
	...
	private void writeDataTypesSheet(WritableWorkbook workbook, int tabIndex) throws WriteException {
		...
		List<UserDefinedTypeType> userDefinedTypes = Editor14.getStore14().getElements(UserDefinedTypeType.class);
	...
	private void writeAppendixTypesSheet(WritableWorkbook workbook, int tabIndex) throws WriteException {
		...
		MiscellaneousPanelControl14 miscellaneousPC = MainFrameControl14.getMiscellaneousPC();
		ElementType elementType = null;
		nl.visi.interaction_framework.editor.v14.MiscellaneousPanelControl14.ComplexElementsTableModel complexElementsTableModel = null;
//		do {
