...
public class CopyTransaction {
	...
	public void copyInternalRelations(TransactionTypeType origTransactionType, TransactionTypeType copyTransactionType,
			boolean includeElemCond) {
					...
					for (ElementConditionType origEC : ecList) {
						...
						if (messageInTransaction != null) {
							...
							if (ecMitt.getId().equals(origMitt.getId())) {
								...
								MessageInTransaction copyMessageInTransaction = objectFactory
										.createElementConditionTypeMessageInTransaction();
								MessageInTransactionTypeTypeRef copyMessageInTransactionRef = objectFactory
