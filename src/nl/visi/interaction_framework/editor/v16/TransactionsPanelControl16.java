			...
			transactionCopyDialogControl.addPropertyChangeListener(new PropertyChangeListener() {
				...
				public void propertyChange(PropertyChangeEvent evt) {
					...
					if (evt.getNewValue().equals("shallow_copy")) {
						...
						copyTransactionType = ct.copyAttributes(origTransactionType);
						ct.copyInternalRelations(origTransactionType, copyTransactionType);
					}
...
//				TransactionTypeType copyAttributes(TransactionTypeType origTransactionType) {
...
//				}
//
//				void copyInternalRelations(TransactionTypeType origTransactionType,
//						TransactionTypeType copyTransactionType) {
//
//					Store16 store = Editor16.getStore16();
//
//					try {
//						for (MessageInTransactionTypeType origMitt : messagesTableModel.elements) {
...
//				}
//
//				private void copyAppendices(TransactionTypeType transactionType,
//						TransactionTypeType copyTransactionType) {
...
//				}
//
//				private void copySubtransactions(TransactionTypeType transactionType,
//						TransactionTypeType copyTransactionType) {
...
//				}
//
//				private void copyExecutor(TransactionTypeType transactionType,
//						TransactionTypeType copyTransactionType) {
...
//						}
//						if (roleType != null) {
//							TransactionTypeType.Executor copyExecutor = objectFactory
...
//				}
//
//				private void copyInitiator(TransactionTypeType transactionType,
//						TransactionTypeType copyTransactionType) {
...
//						}
//						if (roleType != null) {
//							TransactionTypeType.Initiator copyInitiator = objectFactory
