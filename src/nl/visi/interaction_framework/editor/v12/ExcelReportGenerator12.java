...
import nl.visi.interaction_framework.editor.v12.ComplexElementsPanelControl12.SimpleElementsTableModel;
import nl.visi.interaction_framework.editor.v12.ComplexElementsPanelControl12.SubComplexElementsTableModel;
import nl.visi.interaction_framework.editor.v12.MainFrameControl12.Tabs;
import nl.visi.interaction_framework.editor.v12.MessagesPanelControl12.ComplexElementsTableModel;
import nl.visi.interaction_framework.editor.v12.MessagesPanelControl12.TransactionsTableModel;
import nl.visi.interaction_framework.editor.v12.TransactionsPanelControl12.MessagesTableModel;
...
class ExcelReportGenerator12 extends Control12 {

	private final MainFrameControl12 mainFrameControl;

	public ExcelReportGenerator12(MainFrameControl12 mainFrameControl) {
	...
	private void writeRoleTypesSheet(WritableWorkbook workbook, int tabIndex) throws WriteException {
		...
		List<RoleTypeType> roleTypes = Editor12.getStore12().getElements(RoleTypeType.class);
	...
	private void writeTransactionTypesSheet(WritableWorkbook workbook, int tabIndex) throws WriteException {
		...
		List<TransactionTypeType> transactionTypes = Editor12.getStore12().getElements(TransactionTypeType.class);
		for (TransactionTypeType transactionType : transactionTypes) {
			...
			TransactionsPanelControl12 transactionsPC = MainFrameControl12.getTransactionsPC();
	...
	private void writeMessageTypesSheet(WritableWorkbook workbook, int tabIndex) throws WriteException {
		...
		int messageIndex = -1;
		List<MessageTypeType> messageTypes = Editor12.getStore12().getElements(MessageTypeType.class);
		for (MessageTypeType messageType : messageTypes) {
			...
			MessagesPanelControl12 messagesPC = MainFrameControl12.getMessagesPC();
	...
	private void writeComplexElementTypesSheet(WritableWorkbook workbook, int tabIndex) throws WriteException {
		...
		List<ComplexElementTypeType> complexElementTypes = Editor12.getStore12()
		...
		for (ComplexElementTypeType complexElementType : complexElementTypes) {
			...
			ComplexElementsPanelControl12 complexElementsPC = MainFrameControl12.getComplexElementsPC();
	...
	private void writeSimpleElementTypesSheet(WritableWorkbook workbook, int tabIndex) throws WriteException {
		...
		List<SimpleElementTypeType> simpleElementTypes = Editor12.getStore12().getElements(SimpleElementTypeType.class);
	...
	private void writeDataTypesSheet(WritableWorkbook workbook, int tabIndex) throws WriteException {
		...
		List<UserDefinedTypeType> userDefinedTypes = Editor12.getStore12().getElements(UserDefinedTypeType.class);
	...
	private void writeAppendixTypesSheet(WritableWorkbook workbook, int tabIndex) throws WriteException {
		...
		MiscellaneousPanelControl12 miscellaneousPC = MainFrameControl12.getMiscellaneousPC();
		ElementType elementType = null;
		nl.visi.interaction_framework.editor.v12.MiscellaneousPanelControl12.ComplexElementsTableModel complexElementsTableModel = null;
//		do {
...
//		} while (!(elementType instanceof AppendixTypeType) && miscellaneousIndex < miscellaneousPC.tbl_Elements.getRowCount());
		List<AppendixTypeType> appendixTypes = Editor12.getStore12().getElements(AppendixTypeType.class);
