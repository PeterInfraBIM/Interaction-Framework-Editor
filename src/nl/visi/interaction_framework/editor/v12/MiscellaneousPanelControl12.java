...
public class MiscellaneousPanelControl12 extends PanelControl12<ElementType> {
	...
	public MiscellaneousPanelControl12() throws Exception {
	...
	public void deleteElement() {
		...
		case AppendixType:
			break;
		case GroupType:
			mittElements = Editor12.getStore12().getElements(MessageInTransactionTypeType.class);
		...
		Editor12.getStore12().remove(elementType.getId());
	}
